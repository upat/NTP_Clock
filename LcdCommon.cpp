...
void LcdCommon_draw_weather( char *http_buff, char *sensor_data, uint8_t buff_length )
{
  ...
  lcd.println( "C" );
  lcd.fillRect( http_cursor + http_strlen, 70, 4, 4, LCD_COMMON_ORANGE );
  ...
  lcd.println( "C" );
  lcd.fillRect( sensor_cursor + sensor_strlen, 96, 6, 6, LCD_COMMON_ORANGE );
#elif defined ( ESP8266 )
  /* 画面上の文字の長さ */
